...
const DeliveryProfileScreen: React.FC = () => {
  ...
  useEffect(() => {
    console.log('DeliveryProfileScreen useEffect ejecutado');
    loadProfileData();
    setTimeout(() => {
      console.log('DeliveryProfileScreen carga completada');
      setIsLoaded(true);
    }, 1000);
  }, []);
  ...
  const handleEditProfile = () => {
    ...
    navigation.navigate('DeliveryEditProfile' as never);
  };
  ...
  const handleSettingsPress = () => {
    navigation.navigate('DeliverySettings' as never);
  };
  ...
  console.log('DeliveryProfileScreen render - isLoaded:', isLoaded, 'user:', user);
          ...
          <View style={styles.profileSection}>
            ...
            <View style={styles.userInfo}>
              ...
              <Text style={[styles.userEmail, { color: colors.textSecondary }]}>
                {user?.email || 'delivery@piezasya.com'}
              </Text>
