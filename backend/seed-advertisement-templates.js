...
const AdvertisementTemplate = require('./src/models/AdvertisementTemplate');
...
async function seedTemplates() {
  try {
    console.log('🌱 Inicializando plantillas de publicidad...');
    
    // Eliminar plantillas existentes
    await AdvertisementTemplate.deleteMany({});
    console.log('✅ Plantillas existentes eliminadas');
    
    // Insertar nuevas plantillas
    const templates = await AdvertisementTemplate.insertMany(defaultTemplates);
