  ...
  try {
    ...
    createdSubscriptions.forEach(sub => {
      ...
      console.log(`   Tipo: ${sub.type}`);
             console.log(`   Productos máx: ${sub.maxProducts === 999999 ? 'Ilimitado' : sub.maxProducts}`);
       console.log(`   Tiendas máx: ${sub.maxStores === 999999 ? 'Ilimitado' : sub.maxStores}`);
