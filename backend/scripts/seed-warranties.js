...
// Importar modelos usando require con compilación TypeScript
const Warranty = require('../dist/models/Warranty').default || require('../src/models/Warranty');
...
async function seedWarranties() {
  try {
    ...
    if (!adminUser) {
      console.log('⚠️ No se encontró usuario admin, creando garantías sin creador asignado');
    }
    ...
    for (const config of warrantyConfigs) {
      ...
      const warranty = new Warranty({
        ...
        storeId: adminUser ? adminUser._id : null, // Usar admin como tienda de ejemplo
        transactionId: null,
        productId: null,
