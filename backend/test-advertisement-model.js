...
async function testAdvertisementModel() {
  try {
    console.log('🧪 Iniciando pruebas del modelo de publicidad...\n');
    ...
    // 2. Crear una publicidad de prueba con ObjectId ficticios
    console.log('\n2. Creando publicidad de prueba...');
    const testAdvertisement = new Advertisement({
      ...
      store: new mongoose.Types.ObjectId(), // ObjectId ficticio
      ...
      createdBy: new mongoose.Types.ObjectId(), // ObjectId ficticio
      status: 'active'
    });
    ...
    console.log('\n🎉 ¡Todas las pruebas del modelo de publicidad fueron exitosas!');
