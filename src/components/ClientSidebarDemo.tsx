...
const ClientSidebarDemo: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="px-4 py-3">
          <h1 className="text-xl font-bold text-gray-900 dark:text-white">
            Sidebar del Cliente - Demostración
          </h1>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Prueba el sidebar sin logo y con botón de colapsar
          </p>
        </div>
      </header>
      ...
      <div className="fixed bottom-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4 max-w-sm">
        ...
        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          <li>• Sin logo en la parte superior</li>
          <li>• Botón para colapsar/expandir</li>
          <li>• Menú específico para el cliente</li>
          <li>• Responsive y ocultable</li>
          <li>• Integrado con el header</li>
        </ul>
      </div>
    </div>
  );
...
export default ClientSidebarDemo;
