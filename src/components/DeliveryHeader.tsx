      ...
      if (user) {
        try {
          ...
          if (error.message === 'Usuario no autenticado') {
            console.log('DeliveryHeader: Token inválido, pero manteniendo sesión local');
          }
        } finally {
          ...
          {isUserMenuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#333333] rounded-lg shadow-lg border border-gray-200 dark:border-[#555555] py-2 z-50">
              ...
              <button
                ...
                className="flex items-center space-x-3 px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 w-full text-left"
              >
