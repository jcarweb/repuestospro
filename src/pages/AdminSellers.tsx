...
const AdminSellers: React.FC = () => {
    ...
    try {
      ...
      const mockSellers: Seller[] = [
        ...
        },
        {
          _id: 'seller2',
          name: 'Ana Rodríguez',
          email: 'ana.rodriguez@autopartes.com',
          phone: '0424-9876543',
          isActive: true,
          canViewPrices: true,
          canChat: true,
        ...
        },
        {
          _id: 'seller3',
          name: 'Luis Herrera',
          email: 'luis.herrera@todorepuestos.com',
          phone: '0416-5554433',
          isActive: false,
          canViewPrices: true,
          canChat: false,
  ...
  const fetchStores = async () => {
    try {
      ...
      const mockStores: Store[] = [
        {
          _id: 'store1',
          name: 'Repuestos Pro C.A.',
          address: 'Calle Comercio, Local 5, Caracas',
          phone: '0212-7654321',
        ...
        },
        {
          _id: 'store3',
          name: 'Todo Repuestos',
          address: 'Av. Los Cedros, Galpón 1, Maracay',
          phone: '0243-9988776',
          email: 'info@todorepuestos.com',
          isActive: false,
          branches: [
            {
              _id: 'branch4',
  ...
  const handleCreateSeller = async () => {
    ...
    try {
      ...
      const selectedBranch = selectedStore?.branches.find(b => b._id === formData.branchId);
  ...
  const filteredSellers = sellers.filter(seller => {
    ...
    const matchesStore = filterStore === 'all' || seller.storeId === filterStore;
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Gestión Global de Vendedores</h1>
          <p className="text-gray-600 mt-2">Administra vendedores de todas las tiendas</p>
        </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {new Set(sellers.map(s => s.storeId)).size}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Buscar vendedores, tiendas..."
                    ...
                    <tr key={seller._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-900">{seller.storeName}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <button
                            onClick={() => {
                              ...
                              setFormData({
                                ...
                                canViewPrices: seller.canViewPrices,
                                canChat: seller.canChat,
                                canCreateQuotes: seller.canCreateQuotes,
                                maxDiscountPercentage: seller.maxDiscountPercentage,
                                assignedCategories: seller.assignedCategories,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        setFormData({...formData, storeId: e.target.value, branchId: ''});
                      }}
                    >
